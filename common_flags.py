...
gflags.DEFINE_integer('output_size', 13, 'The output size at the end of the deep model')
...
gflags.DEFINE_bool('plot_ds', True, 'Whether to plot the dataset during its generation')
