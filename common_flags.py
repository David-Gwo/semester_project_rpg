...
gflags.DEFINE_string('checkpoint_dir', "./tests/test_small_ts_4/cp.ckpt", "Directory name to save checkpoints and logs.")
gflags.DEFINE_string('euroc_dir', './data/EuRoC_dataset_0/', 'Directory of the EuRoC dataset')
