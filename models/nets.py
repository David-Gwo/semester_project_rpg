...
from models.customized_tf_funcs.custom_layers import ForkLayer, ForkLayerIMUstate, ExponentialRemappingLayer, \
    ForkLayerIMUdt, DiffConcatenationLayer
...
def imu_integration_net(window_len, input_state_len, output_state_len):
    ...
    imu_stack, time_diff_imu, state_0 = ForkLayerIMUstate(window_len, input_state_len, name="forking_layer")(net_in)
...
def split_imu_integration_net(window_len, input_state_len, diff_state_len, output_state_len):
    ...
    conv_kernel_width = min([window_len, 2])
    imu_in = Input((window_len, 7, 1), name="imu_img_input")
